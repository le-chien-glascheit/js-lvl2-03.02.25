...
import AdHocComponent from './AdHoc.component.mjs';

const formService = new FormService('/api/xhr/text');
/** @type {HTMLDivElement} */
const widgetEl = document.querySelector('[data-widget="adhoc"]');
const wigdetInstance = new AdHocComponent(widgetEl, formService);
